...
public class FriendController {
    ...
    public ResponseEntity<ApiResponse<?>> sendFriendRequest(@RequestBody FriendRequestReq friendRequestReq) {
        try {
            FriendRequestResponse response = friendRequestService.sendFriendRequest(friendRequestReq);
